...
if version_info.get("latest_version") != "2.0.13":
    errors.append("version.json latest_version must be 2.0.13")
if version_info.get("min_supported_version") != "2.0.13":
    errors.append("version.json min_supported_version must be 2.0.13 for forced rollout")
