...
class ReleasePreflightTests(unittest.TestCase):
    ...
    def test_version_json_rejects_bad_url_and_sha_format(self):
        ...
        self.assertIn("download_url_onedir must be an HTTPS release URL for v2.0.23", check["problems"])
                ...
                json.dumps(
                    {
                        ...
                        "mandatory": True,
                        "package_type": "onefile_exe",
                        "download_url": "https://mirror.example.com/1fear/TakSklad/releases/download/v2.0.23/TakSklad.exe",
                        "sha256": "a" * 64,
                        "download_url_onedir": "https://github.com/1fear/TakSklad/releases/download/v2.0.23/TakSklad-windows-x64.zip",
                        "sha256_onedir": "b" * 64,
                    },
