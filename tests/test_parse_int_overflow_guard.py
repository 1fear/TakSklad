...
DEFINITION_RE = re.compile(r"^def (parse_int|parse_int_value)\(", re.MULTILINE)
...
class ParseIntOverflowGuardTests(unittest.TestCase):
    ...
    def test_implementation_list_covers_every_copy_in_the_tree(self):
        ...
        declared = set(PARSE_INT_IMPLEMENTATIONS)
        self.assertEqual(
            found,
            declared,
            "список PARSE_INT_IMPLEMENTATIONS разошёлся с деревом: "
