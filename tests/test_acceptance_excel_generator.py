...
class AcceptanceExcelGeneratorTests(unittest.TestCase):
    ...
    def test_acceptance_kit_contains_manifest_and_readme_without_secrets(self):
        ...
        self.assertIn('"windows_install_signed"', manifest_text)
        self.assertNotIn('"windows_launch_source_auto"', manifest_text)
        ...
        self.assertNotIn("-UsePython", readme_text)
        self.assertIn("unsigned test archive synthetic-only", readme_text)
