...
class FeatureAcceptanceStatusTests(unittest.TestCase):
    ...
    def test_current_register_reports_manual_acceptance_complete(self):
        ...
        self.assertEqual(result["stories"]["total"], 44)
        self.assertEqual(result["stories"]["automated_passed"], 43)
        self.assertEqual(result["test_loop"]["total"], 44)
        self.assertEqual(result["manual_acceptance"]["total"], 42)
