...
class VdsAcceptanceScriptsTests(unittest.TestCase):
    def test_acceptance_status_checks_manifest_template_and_rollout_safety(self):
        ...
        expected_fragments = [
            ...
            'daily_report_recovery_verification.get("catchup_success_count") == 2',
            'daily_report_recovery_verification.get("remaining_unrelated_blocker_count") == 1',
            "daily-report recovery readiness proof is invalid",
