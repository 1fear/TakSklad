...
All archive and XML limits are checked before openpyxl sees the workbook.  Error
messages intentionally contain fixed codes only so rejected filenames or cell
contents cannot leak into logs or API responses.
"""
