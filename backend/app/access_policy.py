...
ROUTE_POLICIES: dict[tuple[str, str], RoutePolicy] = {
    ...
    ("POST", "/api/v1/admin/google/pending/retry"): _protected(PERMISSION_ADMIN_WRITE, "admin:write", mutates=True),
    ...
    ("POST", "/api/v1/admin/orders/{order_id}/resync-google"): _protected(PERMISSION_ADMIN_WRITE, "admin:write", mutates=True),
